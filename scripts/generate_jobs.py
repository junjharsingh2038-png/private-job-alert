...
def company_domain(company):
    n = re.sub(r'\b(pvt|private|limited|ltd|llp|inc|india|company|corporation|corp|industries|industry|infrastructure|power)\b', ' ', str(company or '').lower())
...
def page(job):
    ...
    html = '''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>__TITLE__ | __COMPANY__ | Private Jobs Rajasthan</title><meta name="description" content="__META_DESCRIPTION__"><meta name="robots" content="index,follow,max-image-preview:large"><link rel="canonical" href="__URL__"><meta property="og:type" content="website"><meta property="og:title" content="__TITLE__ | __COMPANY__ | Private Jobs Rajasthan"><meta property="og:description" content="__META_DESCRIPTION__"><meta property="og:url" content="__URL__"><meta property="og:image" content="__LOGO__"><meta property="og:image:alt" content="__COMPANY__ logo"><meta name="twitter:card" content="summary"><meta name="twitter:title" content="__TITLE__ | __COMPANY__"><meta name="twitter:description" content="__META_DESCRIPTION__"><meta name="twitter:image" content="__LOGO__"><link rel="stylesheet" href="../../style.css"><script type="application/ld+json">__SCHEMA__</script><script type="application/ld+json">__BREADCRUMB__</script></head><body><header><div class="brand">💼 PRIVATE JOB ALERT RAJASTHAN</div><nav><a href="../../">Home</a> <a href="../../#jobs">Latest Jobs</a> <a href="../../categories/">Job Categories</a></nav></header><main><article class="job" style="max-width:900px;margin:30px auto"><p class="muted"><a href="../../">Home</a> › <a href="../../#jobs">Latest Jobs</a> › __TITLE__</p><h1>__TITLE__</h1><h2>__COMPANY__</h2><p class="muted">📍 __LOCATION__ &nbsp; 🎓 __QUALIFICATION__ &nbsp; 💰 __SALARY__ &nbsp; 🕒 __JOB_TYPE__</p><hr><h3>Job Description</h3><p>__DESCRIPTION__</p><h3>How to Apply</h3><p>Click Apply Now and submit your candidate details and resume. Your application will be sent to the HR email configured for this vacancy.</p><button class="apply" id="applyButton">Apply Now →</button><p><a href="../../">← View Latest Private Jobs in Rajasthan</a></p></article></main><div id="modal" class="modal hidden"><div class="box"><button class="close" onclick="closeModal()">×</button><div id="modalContent"></div></div></div><script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="../../app.js"></script><script>document.getElementById("applyButton").addEventListener("click", async function () {const r = await sb.from("jobs").select("id,title,company,location,qualification,salary,job_type,description,hr_email,created_at").eq("id", __JOB_ID__).eq("is_active", true).single();if (r.error || !r.data) { alert("This job is no longer available."); return; }openApply(r.data);});</script></body></html>'''
...
for job in jobs:
    name = job_slug(job); active.add(name); url = f'{BASE}/jobs/{name}/'; folder = JOBS_DIR / name; folder.mkdir(parents=True, exist_ok=True); (folder / 'index.html').write_text(page(job), encoding='utf-8'); urls.append(url); job_links.append((url, clean_text(job.get('title'), 'Private Job'), clean_text(job.get('company'), 'Employer'), clean_text(job.get('location'), 'Rajasthan'), clean_text(job.get('qualification'), 'Any qualification')))
...
jobs_html = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Latest Private Jobs in Rajasthan 2026 | Private Job Alert</title><meta name="description" content="Latest private jobs in Rajasthan 2026. Find current vacancies in Barmer, Jodhpur, Jaipur, Bikaner and other cities by qualification, company and job type."><meta name="robots" content="index,follow,max-image-preview:large"><link rel="canonical" href="{BASE}/jobs/"><link rel="stylesheet" href="../style.css"></head><body><header><a class="brand" href="../">💼 <span>PRIVATE JOB ALERT</span><small>RAJASTHAN</small></a><nav><a href="../">Home</a><a href="../categories/">Job Categories</a><a href="../hr.html">For HR</a></nav></header><main><section class="hero"><span>✓ LATEST PRIVATE JOBS</span><h1>Latest Private Jobs in Rajasthan 2026</h1><p>Browse current private-sector vacancies by job title, company, location and qualification. New job pages are added automatically when employers post active vacancies.</p></section><section><h2>Current Vacancies</h2>{items or '<p>No active vacancies are currently available. Please check again soon.</p>'}</section><section><h2>Popular Job Searches</h2><p><a href="../categories/10th-pass-jobs-rajasthan/">10th Pass Jobs</a> · <a href="../categories/12th-pass-jobs-rajasthan/">12th Pass Jobs</a> · <a href="../categories/graduate-jobs-rajasthan/">Graduate Jobs</a> · <a href="../categories/fresher-jobs-rajasthan/">Fresher Jobs</a> · <a href="../categories/work-from-home-jobs-rajasthan/">Work From Home Jobs</a></p></section></main><footer>© 2026 Private Job Alert Rajasthan</footer></body></html>'''
